...
import { getQueuedReports, getSyncStats } from '@core/offline';
...
/* =========================================================================
   ...
   ========================================================================= */
function FrontDeskDashboard({ onNavigate, syncStats, recentReports }) {
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-[#0f172a] border border-[#334155] rounded-lg px-2.5 py-2 text-slate-100 focus:border-sky-500 focus:outline-none text-[11px] cursor-pointer disabled:opacity-50"
                >
                  <option value="">{loadingClinics ? '-- Loading clinics... --' : '-- None (Direct Walk-In) --'}</option>
                  {clinics.map((clinic) => (
